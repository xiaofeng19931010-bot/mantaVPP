...
<!-- Pagination removed -->
                ...
                <div class="flex flex-col gap-4 items-start relative shrink-0 w-full mb-4">
                    ...
                    <div class="bg-[#f3f3f6] flex gap-[4px] items-center p-[4px] relative rounded-[4px] shrink-0 w-fit">
                        ${['All', 'Discharge', 'Normal', 'Charge', 'Abnormal'].map(type => {
                            ...
                            let iconSvg = '';
                            if (type === 'All') {
                                iconSvg = `<svg class="w-4 h-4 text-[#313949]" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M7.36285 8.66861V14.002H2.02954V8.66861H7.36285ZM14.0295 8.66861V14.002H8.6962V8.66861H14.0295ZM6.02954 10.002H3.36285V12.6686H6.02954V10.002ZM12.6962 10.002H10.0295V12.6686H12.6962V10.002ZM7.36285 2.00195V7.33523H2.02954V2.00195H7.36285ZM14.0295 2.00195V7.33523H8.6962V2.00195H14.0295ZM12.6962 3.33527H10.0295V6.00195H12.6962V3.33527Z" fill="currentColor"/></svg>`;
                            } else if (type === 'Discharge') {
                                iconSvg = `<svg class="w-4 h-4 text-[#313949]" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M7.85 12.7167L10.6167 7.31667C10.6722 7.20556 10.6667 7.09711 10.6 6.99133C10.5333 6.88556 10.4389 6.83289 10.3167 6.83333H8.53333V3.35C8.53333 3.26111 8.49178 3.20822 8.40867 3.19133C8.32556 3.17444 8.26156 3.20511 8.21667 3.28333L5.45 8.68333C5.39445 8.79445 5.4 8.90289 5.46667 9.00867C5.53333 9.11445 5.62778 9.16711 5.75 9.16667H7.53333V12.65C7.53333 12.7389 7.57511 12.7918 7.65867 12.8087C7.74222 12.8256 7.806 12.7949 7.85 12.7167ZM8 14.6667C7.07778 14.6667 6.21111 14.4916 5.4 14.1413C4.58889 13.7911 3.88333 13.3162 3.28333 12.7167C2.68333 12.1171 2.20845 11.4116 1.85867 10.6C1.50889 9.78845 1.33378 8.92178 1.33333 8C1.33289 7.07822 1.508 6.21156 1.85867 5.4C2.20933 4.58845 2.68422 3.88289 3.28333 3.28333C3.88245 2.68378 4.588 2.20889 5.4 1.85867C6.212 1.50844 7.07867 1.33333 8 1.33333C8.92133 1.33333 9.788 1.50844 10.6 1.85867C11.412 2.20889 12.1176 2.68378 12.7167 3.28333C13.3158 3.88289 13.7909 4.58845 14.142 5.4C14.4931 6.21156 14.668 7.07822 14.6667 8C14.6653 8.92178 14.4902 9.78845 14.1413 10.6C13.7924 11.4116 13.3176 12.1171 12.7167 12.7167C12.1158 13.3162 11.4102 13.7913 10.6 14.142C9.78978 14.4927 8.92311 14.6676 8 14.6667ZM8 13.3333C9.47778 13.3333 10.7362 12.814 11.7753 11.7753C12.8144 10.7367 13.3338 9.47822 13.3333 8C13.3329 6.52178 12.8136 5.26333 11.7753 4.22467C10.7371 3.186 9.47867 2.66667 8 2.66667C6.52133 2.66667 5.26289 3.18622 4.22467 4.22533C3.18645 5.26444 2.66711 6.52267 2.66667 8C2.66622 9.47733 3.18578 10.7358 4.22533 11.7753C5.26489 12.8149 6.52311 13.3342 8 13.3333Z" fill="#EC981C"/></svg>`;
                            } else if (type === 'Normal') {
                                iconSvg = `<svg class="w-4 h-4 text-[#313949]" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M8 1.33333C4.32 1.33333 1.33333 4.32 1.33333 8C1.33333 11.68 4.32 14.6667 8 14.6667C11.68 14.6667 14.6667 11.68 14.6667 8C14.6667 4.32 11.68 1.33333 8 1.33333ZM8 13.3333C5.06 13.3333 2.66667 10.94 2.66667 8C2.66667 5.06 5.06 2.66667 8 2.66667C10.94 2.66667 13.3333 5.06 13.3333 8C13.3333 10.94 10.94 13.3333 8 13.3333ZM11.06 5.05333L6.66667 9.44667L4.94 7.72667L4 8.66667L6.66667 11.3333L12 6L11.06 5.05333Z" fill="#3EC064"/></svg>`;
                            } else if (type === 'Charge') {
                                iconSvg = `<svg class="w-4 h-4 text-[#313949]" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M5.33333 12.6667H2C1.82319 12.6667 1.65362 12.5964 1.5286 12.4714C1.40357 12.3464 1.33333 12.1768 1.33333 12V4C1.33333 3.82319 1.40357 3.65362 1.5286 3.5286C1.65362 3.40357 1.82319 3.33333 2 3.33333H6.41667L5.63867 4.66667H2.66667V11.3333H5.33333V12.6667ZM8.25 12.6667L9.028 11.3333H12V4.66667H9.33333V3.33333H12.6667C12.8435 3.33333 13.013 3.40357 13.1381 3.5286C13.2631 3.65362 13.3333 3.82319 13.3333 4V12C13.3333 12.1768 13.2631 12.3464 13.1381 12.4714C13.013 12.5964 12.8435 12.6667 12.6667 12.6667H8.25ZM14 6H15.3333V10H14V6ZM8 7.33333H10L6.66667 12.6667V8.66667H4.66667L8 3.33333V7.33333Z" fill="#1578D0"/></svg>`;
                            } else if (type === 'Abnormal') {
                                iconSvg = `<svg class="w-4 h-4 text-[#313949]" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M6.89697 7.90169C6.72016 7.90169 6.55059 7.83141 6.42557 7.70643C6.30054 7.58141 6.23031 7.41184 6.23031 7.23503V5.23503C6.23031 5.05822 6.30054 4.88865 6.42557 4.76362C6.55059 4.6386 6.72016 4.56836 6.89697 4.56836C7.07378 4.56836 7.24335 4.6386 7.36838 4.76362C7.4934 4.88865 7.56364 5.05822 7.56364 5.23503V7.23503C7.56364 7.41184 7.4934 7.58141 7.36838 7.70643C7.24335 7.83145 7.07378 7.90169 6.89697 7.90169ZM5.89697 9.56836C5.89697 9.30314 6.00233 9.04879 6.18987 8.86125C6.3774 8.67372 6.63176 8.56836 6.89697 8.56836C7.16219 8.56836 7.41654 8.67372 7.60408 8.86125C7.79162 9.04879 7.89697 9.30314 7.89697 9.56836C7.89697 9.83358 7.79162 10.0879 7.60408 10.2755C7.41654 10.463 7.16219 10.5684 6.89697 10.5684C6.63176 10.5684 6.3774 10.463 6.18987 10.2755C6.00233 10.0879 5.89697 9.83358 5.89697 9.56836Z" fill="#FF3434"/><path d="M5.71698 0.7125C6.21698 -0.2375 7.57698 -0.2375 8.07698 0.7125L13.639 11.2805C14.1063 12.1685 13.4637 13.2352 12.459 13.2352H1.33498C0.33165 13.2352 -0.311684 12.1685 0.154983 11.2812L5.71698 0.7125ZM12.4596 11.9018L6.89698 1.33317L1.33432 11.9018H12.4596Z" fill="#FF3434"/></svg>`;
                            }
    ...
    openGuidanceModal(step = 1) {
        ...
        const isSolisOrFox = (vendor === 'Ginlong (Solis)' || vendor === 'Fox');
            ...
            stepContent = `
                <div class="flex flex-col gap-[16px]">
                    ...
                    <div class="flex justify-end mt-[8px]">
                        <button onclick="app.openGuidanceModal(${isSolisOrFox ? 2 : 2})" class="flex items-center gap-[8px] px-[16px] py-[8px] bg-[#3ec064] hover:bg-[#35a656] text-white rounded-[4px] transition-colors text-[14px] font-medium">
                            Next Step
            ...
            if (isSolisOrFox) {
                stepContent = `
                    <div class="flex flex-col gap-[16px]">
                        ...
                        <div class="w-full aspect-[16/9] bg-[#f8f9fb] border border-[#e6e8ee] rounded-[8px] flex items-center justify-center overflow-hidden relative group">
                            <div class="flex flex-col items-center text-[#b5bcc8]">
                                <i data-lucide="link" class="w-[48px] h-[48px] mb-[8px]"></i>
                                <span class="text-[14px]">Redirect URL Thumbnail</span>
                            </div>
                        </div>
                ...
                stepContent = `
                    <div class="flex flex-col gap-[16px]">
                        ...
                        <div class="flex justify-between mt-[8px]">
                            ...
                            <button onclick="app.openGuidanceModal(5)" class="flex items-center gap-[8px] px-[16px] py-[8px] bg-[#3ec064] hover:bg-[#35a656] text-white rounded-[4px] transition-colors text-[14px] font-medium">
                                Next Step
                                <i data-lucide="arrow-right" class="w-[16px] h-[16px]"></i>
                            </button>
                        </div>
